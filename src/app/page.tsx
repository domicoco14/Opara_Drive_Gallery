...
export default async function Home(props: { searchParams: Promise<{ [key: string]: string | undefined }> }) {
  ...
  // Fallback to mock data if the database is empty (until user deploys real cars)
  if (cars.length === 0) {
    const mockCars = [
      {
        id: "mock-1",
      ...
      },
      {
        ...
        mileage_type: "Foreign Used",
        body_type: "Sedan",
        images: ["https://images.unsplash.com/photo-1629897048514-3dd74143fcfa?q=80&w=1000&auto=format&fit=crop"],
        status: "Available",
      },
      {
        id: "mock-7",
        ...
        mileage_type: "Foreign Used",
        body_type: "Sedan",
        images: ["https://images.unsplash.com/photo-1605810731770-49818816c4f0?q=80&w=1000&auto=format&fit=crop"],
        status: "Available",
      },
      {
        id: "mock-8",
      ...
      },
      {
        ...
        mileage_type: "Brand New",
        body_type: "SUV",
        images: ["https://images.unsplash.com/photo-1590362891911-c6126ed37286?q=80&w=1000&auto=format&fit=crop"],
        status: "Available",
      },
      {
        id: "mock-10",
        ...
        mileage_type: "Foreign Used",
        body_type: "SUV",
        images: ["https://images.unsplash.com/photo-1563720223185-11003d516935?q=80&w=1000&auto=format&fit=crop"],
        status: "Available",
      },
      {
        id: "mock-11",
      ...
      },
      {
        ...
        mileage_type: "Foreign Used",
        body_type: "SUV",
        images: ["https://images.unsplash.com/photo-1559404289-e15fc36d9333?q=80&w=1000&auto=format&fit=crop"],
        status: "Pending Sale",
      }
    ]

    // Apply basic filtering to mock data too so the search still feels interactive
    cars = mockCars.filter(car => {
      let match = true;
      if (searchParams.make && !car.make.toLowerCase().includes(searchParams.make.toLowerCase())) match = false;
      if (searchParams.body_type && !car.body_type.toLowerCase().includes(searchParams.body_type.toLowerCase())) match = false;
      if (searchParams.mileage_type && car.mileage_type !== searchParams.mileage_type) match = false;
      return match;
    }) as any[]
  }
